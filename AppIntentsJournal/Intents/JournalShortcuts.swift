...
class JournalShortcuts: AppShortcutsProvider {
    ...
    static var appShortcuts: [AppShortcut] {
        AppShortcut(intent: MoodIntent(), phrases: ["Do a mood check-in in \(.applicationName)",
                                                    "State of mind check-in in \(.applicationName)"], shortTitle: "Mood Check-In", systemImageName: "apple.meditate")
    }
}
